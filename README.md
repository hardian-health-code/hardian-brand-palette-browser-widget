...
## Installation
 ...
 - Select the "Hardian Brand Palette" folder.
 - Click the "puzzle piece" icon in the top right of Chrome to pin the Hardian widget to the toolbar for permanent access.
